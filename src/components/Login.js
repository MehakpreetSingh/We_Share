                ...
                <div className="right-div bg-[#231e3b] w-full md:w-1/2">
                    <div className='mt-28 transition:all flex flex-col items-center justify-center space-y-10 w-full'>
                        <div className='flex justify-center items-center space-x-6'>
                            <h1 className='text-white text-3xl heading'>Login</h1>
                        </div>
                        <form onSubmit={handleSubmit} id="form-type" className='transition-opacity flex flex-col justify-center w-2/3 md:w-5/6 items-center my-4 space-y-5 p-5 shadow-2xl rounded-lg border-gray-100'>
                            ...
                            <button className=' button-shadow flex items-center space-x-2 justify-center  transition-all hover:scale-110 px-10 text-lg rounded-md hover:shadow-lg bg-[#ffffff] text-[#231e3b]' tpye="Submit">Login</button>
                            <p className='text-sm text-gray-300'>Create An Account<Link to="/signup" className='mx-3 text-green-400 hover:underline'>Sign Up</Link></p>
                        </form>
                    </div>
                </div>
            </div>
